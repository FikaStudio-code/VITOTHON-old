...
op.assignip("r0", epairb, "192.168.11.254", "255.255.255.0")
op.up("r0", epairb)

epaira, epairb = op.createpair()
op.connect("r0", epaira)
op.assignip("r0", epaira, "1.0.0.254", "255.0.0.0")
...
op.connect("bridge0", epairb)
op.assignip("r1", epaira, "1.0.0.1", "255.0.0.0")
op.up("r1", epaira)
op.up("bridge0", epairb)
...
op.connect("bridge0", epairb)
op.assignip("r2", epaira, "1.0.0.2", "255.0.0.0")
op.up("r2", epaira)
op.up("bridge0", epairb)
# op.assigngw("r2", "1.0.0.2")

command("route add -net 1.0.0.0/8 192.168.11.254")
ifconfig("lo0 alias 192.168.100.1 netmask 255.255.255.255 up")
